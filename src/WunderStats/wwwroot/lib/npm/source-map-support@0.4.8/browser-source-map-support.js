    ...
    (function p(v, l, c) {
      ...
      4: [function(p, v, l) {
        ...
        function h(g, m, b, a) {
          ...
          return K.read(g, m, b, 23, 4);
        }
        function n(g, m, b, a) {
          a || (q("boolean" === typeof b, "missing or invalid endian"), q(m + 7 < g.length, "Trying to read beyond buffer length"));
          return K.read(g, m, b, 52, 8);
        }
        function t(g, m, b, a, c) {
          c || (q(void 0 !== m && null !== m, "missing value"), q("boolean" === typeof a, "missing or invalid endian"), q(void 0 !== b && null !== b, "missing offset"), q(b + 1 < g.length, "trying to write beyond buffer length"), H(m, 65535));
          var y = g.length;
          if (!(b >= y))
            for (c = 0, y = Math.min(y - b, 2); c < y; c++)
              g[b + c] = (m & 255 << 8 * (a ? c : 1 - c)) >>> 8 * (a ? c : 1 - c);
        }
        function b(g, b, a, c, f) {
          f || (q(void 0 !== b && null !== b, "missing value"), q("boolean" === typeof c, "missing or invalid endian"), q(void 0 !== a && null !== a, "missing offset"), q(a + 3 < g.length, "trying to write beyond buffer length"), H(b, 4294967295));
          var m = g.length;
          if (!(a >= m))
            for (f = 0, m = Math.min(m - a, 4); f < m; f++)
              g[a + f] = b >>> 8 * (c ? f : 3 - f) & 255;
        }
        function f(g, b, a, c, f) {
          f || (q(void 0 !== b && null !== b, "missing value"), q("boolean" === typeof c, "missing or invalid endian"), q(void 0 !== a && null !== a, "missing offset"), q(a + 1 < g.length, "Trying to write beyond buffer length"), z(b, 32767, -32768));
          a >= g.length || (0 <= b ? t(g, b, a, c, f) : t(g, 65535 + b + 1, a, c, f));
        }
        function F(g, m, a, c, f) {
          f || (q(void 0 !== m && null !== m, "missing value"), q("boolean" === typeof c, "missing or invalid endian"), q(void 0 !== a && null !== a, "missing offset"), q(a + 3 < g.length, "Trying to write beyond buffer length"), z(m, 2147483647, -2147483648));
          a >= g.length || (0 <= m ? b(g, m, a, c, f) : b(g, 4294967295 + m + 1, a, c, f));
        }
        function u(g, b, a, c, f) {
          f || (q(void 0 !== b && null !== b, "missing value"), q("boolean" === typeof c, "missing or invalid endian"), q(void 0 !== a && null !== a, "missing offset"), q(a + 3 < g.length, "Trying to write beyond buffer length"), D(b, 3.4028234663852886E38, -3.4028234663852886E38));
          a >= g.length || K.write(g, b, a, c, 23, 4);
        }
        function M(g, b, a, c, f) {
          f || (q(void 0 !== b && null !== b, "missing value"), q("boolean" === typeof c, "missing or invalid endian"), q(void 0 !== a && null !== a, "missing offset"), q(a + 7 < g.length, "Trying to write beyond buffer length"), D(b, 1.7976931348623157E308, -1.7976931348623157E308));
          a >= g.length || K.write(g, b, a, c, 52, 8);
        }
        function I(g, b, a) {
          if ("number" !== typeof g)
            return a;
        ...
        function A(g, b, a, c) {
          for (var m = 0; m < c && !(m + a >= b.length || m >= g.length); m++)
            b[m + a] = g[m];
          return m;
        }
        function E(g) {
        ...
        c.prototype.write = function(g, b, a, f) {
          ...
          switch (f) {
            ...
            case "utf8":
            case "utf-8":
              g = c._charsWritten = A(x(g), this, b, a);
              break;
            case "ascii":
              g = c._charsWritten = A(J(g), this, b, a);
              break;
            case "binary":
              g = c._charsWritten = A(J(g), this, b, a);
              break;
            case "base64":
              g = c._charsWritten = A(C.toByteArray(g), this, b, a);
              break;
            case "ucs2":
            case "ucs-2":
            case "utf16le":
            case "utf-16le":
              ...
              g = c._charsWritten = A(m, this, b, a);
              break;
            default:
              throw Error("Unknown encoding");
          }
          ...
          switch (g) {
            ...
            case "utf-8":
              ...
              for (a = Math.min(this.length, a); b < a; b++)
                127 >= this[b] ? (g += E(f) + String.fromCharCode(this[b]), f = "") : f += "%" + this[b].toString(16);
              a = g + E(f);
              break;
            case "ascii":
              a = e(this, b, a);
            ...
            case "binary":
              ...
              break;
            case "base64":
              a = 0 === b && a === this.length ? C.fromByteArray(this) : C.fromByteArray(this.slice(b, a));
              break;
            case "ucs2":
            case "ucs-2":
            case "utf16le":
        ...
        c.prototype.slice = function(g, a) {
          var b = this.length;
          g = I(g, b, 0);
          a = I(a, b, b);
          if (c._useTypedArrays)
            return c._augment(this.subarray(g, a));
          for (var b = a - g,
              f = new c(b, void 0, !0),
              m = 0; m < b; m++)
            f[m] = this[m + g];
        ...
        c.prototype.inspect = function() {
          for (var b = [],
              a = this.length,
              f = 0; f < a; f++)
            if (b[f] = B(this[f]), f === l.INSPECT_MAX_BYTES) {
              b[f + 1] = "...";
              break;
            }
      ...
      5: [function(p, v, l) {
        ...
        l.write = function(c, e, k, r, d, a) {
          ...
          for (; 8 <= d; c[k + a] = e & 255, a += F, e /= 256, d -= 8)
            ;
          r = r << d | e;
          for (n += d; 0 < n; c[k + a] = r & 255, a += F, r /= 256, n -= 8)
            ;
          c[k + a - F] |= 128 * u;
        };
      }, {}],
      ...
      14: [function(p, v, l) {
        ...
        e.fromSourceMap = function(b) {
          ...
          for (var n = a.__generatedMappings = [],
            ...
            var B = b[r],
                x = new k;
            x.generatedLine = B.generatedLine;
            x.generatedColumn = B.generatedColumn;
            B.source && (x.source = u.indexOf(B.source), x.originalLine = B.originalLine, x.originalColumn = B.originalColumn, B.name && (x.name = c.indexOf(B.name)), l.push(x));
            n.push(x);
          }
        ...
        e.prototype._parseMappings = function(b, a) {
          for (var c = 1,
            ...
            if (";" === b.charAt(x))
              ...
              z = new k;
              z.generatedLine = c;
              for (C = x; C < p && !this._charIsMappingSeparator(b, C); C++)
                ;
              D = b.slice(x, C);
              if (q = v[D])
                x += D.length;
                ...
                for (q = []; x < C; )
                  n.decode(b, x, A), K = A.value, x = A.rest, q.push(K);
                if (2 === q.length)
              ...
              H.push(z);
              "number" === typeof z.originalLine && E.push(z);
            }
          t(H, d.compareByGeneratedPositionsDeflated);
          this.__generatedMappings = H;
          t(E, d.compareByOriginalPositions);
        ...
        c.prototype._serializeMappings = function() {
          for (var a = 0,
            ...
            if (p.generatedLine !== c)
              ...
              if (!k.compareByGeneratedPositionsInflated(p, G[v - 1]))
                continue;
              u += ",";
            }
      ...
      19: [function(p, v, l) {
        (function(c, e) {
          ...
          function v(a) {
            ...
            if (b) {
              ...
              var c = +b[2],
                  b = +b[3],
                  d = A[a];
              !d && G.existsSync(a) && (d = G.readFileSync(a, "utf8"));
              if (d && (d = d.split(/(?:\r\n|\r|\n)/)[c - 1]))
                return a + ":" + c + "\n" + d + "\n" + Array(b).join(" ") + "^";
            }
            return null;
          ...
          D.push(function(a) {
            ...
            a: {
              var c;
              if (k() && (c = new XMLHttpRequest, c.open("GET", a, !1), c.send(null), c = c.getResponseHeader("SourceMap") || c.getResponseHeader("X-SourceMap"))) {
                b = c;
                break a;
              }
              c = q(a);
              for (var f = /(?:\/\/[@#][ \t]+sourceMappingURL=([^\s'"]+?)[ \t]*$)|(?:\/\*[@#][ \t]+sourceMappingURL=([^\*]+?)[ \t]*(?:\*\/)[ \t]*$)/mg,
                  h; h = f.exec(c); )
                b = h;
              b = b ? b[1] : null;
            }
            if (!b)
              return null;
            H.test(b) ? (b = b.slice(b.indexOf(",") + 1), c = (new e(b, "base64")).toString(), b = a) : (b = d(a, b), c = q(b));
            return c ? {
              url: b,
              map: c
            } : null;
          ...
          l.install = function(a) {
            ...
            !B && ("handleUncaughtExceptions" in a ? a.handleUncaughtExceptions : 1) && "object" === typeof c && null !== c && "function" === typeof c.on && (B = !0, u());
          };
