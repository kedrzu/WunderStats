...
(function(process) {
  ...
  (function(ts) {
    ...
    function mapObject(object, f) {
      ...
      if (object) {
        result = {};
        for (var _i = 0,
            _a = getOwnKeys(object); _i < _a.length; _i++) {
          var v = _a[_i];
          var _b = f(v, object[v]) || [undefined, undefined],
              key = _b[0],
              value = _b[1];
          if (key !== undefined) {
            result[key] = value;
    ...
    function assign(t) {
      ...
      for (var _a = 0,
        ...
        var arg = args_1[_a];
        for (var _b = 0,
            _c = getOwnKeys(arg); _b < _c.length; _b++) {
          var p = _c[_b];
          t[p] = arg[p];
        }
      }
  ...
  (function(ts) {
    ts.Diagnostics = {
      ...
      package_json_does_not_have_a_types_or_main_field: {
        code: 6100,
        category: ts.DiagnosticCategory.Message,
        key: "package_json_does_not_have_a_types_or_main_field_6100",
        message: "'package.json' does not have a 'types' or 'main' field."
      },
      ...
      No_types_specified_in_package_json_so_returning_main_value_of_0: {
        code: 6137,
        category: ts.DiagnosticCategory.Message,
        key: "No_types_specified_in_package_json_so_returning_main_value_of_0_6137",
        message: "No types specified in 'package.json', so returning 'main' value of '{0}'"
      },
      ...
      Remove_unused_identifiers: {
        code: 90004,
        category: ts.DiagnosticCategory.Message,
        key: "Remove_unused_identifiers_90004",
        message: "Remove unused identifiers"
      },
      Implement_interface_on_reference: {
        code: 90005,
        category: ts.DiagnosticCategory.Message,
        key: "Implement_interface_on_reference_90005",
        message: "Implement interface on reference"
      },
      Implement_interface_on_class: {
        code: 90006,
        category: ts.DiagnosticCategory.Message,
        key: "Implement_interface_on_class_90006",
        message: "Implement interface on class"
      },
    ...
    function createScanner(languageVersion, skipTrivia, languageVariant, text, onError, start, length) {
      ...
      return {
        ...
        isIdentifier: function() {
          return token === 70 || token > 106;
        },
        isReservedWord: function() {
          return token >= 71 && token <= 106;
        },
  ...
  (function(ts) {
    ...
    function createCompilerDiagnosticForInvalidCustomType(opt) {
      var namesOfType = Object.keys(opt.type).map(function(key) {
        return "'" + key + "'";
      }).join(", ");
  ...
  (function(ts) {
    ...
    function resolvedFromAnyFile(path) {
      return {
        path: path,
        extension: ts.extensionFromPath(path)
      };
    }
    ...
    function nodeModuleNameResolver(moduleName, containingFile, compilerOptions, host) {
      ...
      if (result) {
        var resolved = result.resolved,
            isExternalLibraryImport = result.isExternalLibraryImport;
      ...
      function tryResolve(extensions) {
        ...
        if (moduleHasNonRelativeName(moduleName)) {
          ...
          return resolved_1 && {
            resolved: {
              path: realpath(resolved_1.path, host, traceEnabled),
              extension: resolved_1.extension
            },
