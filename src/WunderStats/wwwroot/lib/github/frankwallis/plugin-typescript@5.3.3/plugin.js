    ...
    function translate(load) {
        ...
        return factory.then(function (_a) {
            ...
            if (isTypescriptDeclaration(load.address)) {
                if (loader.builder && (host.options.module == typescript_1.ModuleKind.ES2015)) {
                    load.source = null;
                ...
                if (!host.options.autoDetectModule) {
                    ...
                    else if (host.options.module === typescript_1.ModuleKind.ES2015)
                        load.metadata.format = 'esm';
        ...
        execute: function () {
            ...
            CompilerHost = (function () {
                function CompilerHost(options, builder) {
                    ...
                    if ((this._options.target !== typescript_1.ScriptTarget.ES2015) && (this._options.module !== typescript_1.ModuleKind.ES2015))
                    ...
                    if (this._options.targetLib) {
                        ...
                        this.options.targetLib = this.getEnum(this._options.targetLib, typescript_1.ScriptTarget, typescript_1.ScriptTarget.ES2015);
                    }
                ...
                CompilerHost.prototype.getDefaultLibFilePaths = function () {
                    ...
                    else if (this._options.targetLib === typescript_1.ScriptTarget.ES2015)
